...
![Workflow Status](https://img.shields.io/github/actions/workflow/status/TavstalDev/PortalLock/ghrelease.yml?branch=stable&label=build&style=plastic-square)
